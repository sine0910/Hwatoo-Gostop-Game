...
public class PlayerAgent
{
    ...
    public byte get_yeol_count()//2021-01-22 14:33 멍박을 체크하기 위한 yeol의 갯수를 받아옴
    {
    ...
    public byte get_tee_count()//2021-01-22 14:33 멍박을 체크하기 위한 yeol의 갯수를 받아옴
    {
    ...
    public bool three_ppuk()
    {
        ...
        {
            //3뻑인 경우 점수는 30점을 받게되고 보너스 점수인 첫 뻑을 제외한 나머지 점수에 관여하는 변수들을 초기화해준다.
            this.score = 30;
            this.go_count = 0;
            this.shaking_count = 0;
            return true;
